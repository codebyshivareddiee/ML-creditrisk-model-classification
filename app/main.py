...
st.set_page_config(page_title="Credit Risk Model : predicts credict risk of an individual", page_icon="@")
st.title("Credit Risk Modelling : predicts credict risk of an individual")
